/* Korean capability panels - extracted verbatim from ../js/main.js (DETAILS)
   so the redesign can consume them standalone as window.SC4_PANELS_KO. */
window.SC4_PANELS_KO = (function () {
